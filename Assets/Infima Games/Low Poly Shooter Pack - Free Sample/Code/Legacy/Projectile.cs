...
public class Projectile : MonoBehaviour {
	...
	private void Start ()
	{
		...
		var playerCharacter = gameModeService.GetPlayerCharacter();
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		//If bullet collides with "Blood" tag or an Enemy
		if (collision.transform.CompareTag("Blood") || enemy != null) 
		{
			//Instantiate random impact prefab from array (ONLY if the array is not empty to avoid errors!)
			...
			// Apply damage to EnemyAI if it exists
			if (enemy != null)
			{
				enemy.TakeDamage(25); // Adjust damage as needed
			}
