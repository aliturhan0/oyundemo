...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CameraLook : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            //Make sure we have a valid player character before accessing its components.
        ...
        private void Start()
        {
            //Make sure we have a valid player character.
            if (playerCharacter == null)
                return;
        ...
        {
            //Make sure we have a valid player character and rigidbody.
            if (playerCharacter == null || playerCharacterRigidbody == null)
                return;
